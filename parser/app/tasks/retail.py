...
def parse_retail_product(self, tracker_id: int, url: str):
    logger.info(f"Parsing retail tracker {tracker_id} for URL: {url}")
    ...
    try:
        ...
        logger.info(
            f"Successfully parsed and updated retail tracker {tracker_id}")
        return result
    except Exception as exc:
        logger.error(f"Error parsing retail tracker {tracker_id}: {str(exc)}")
...
# Comfy offers tasks moved to app.tasks.comfy
...
# Foxtrot offers tasks moved to app.tasks.foxtrot
